...
import  sys
# from .text_helpers import normalize_text, build_dictionary,load_movie_data, text_to_numbers
from nltk.corpus import stopwords
from tensorflow.python.framework import ops
import os

text_helper_path = os.path.join(os.getcwd(),'text_helpers.py')
sys.path.append(text_helper_path)
print(sys.path)
import text_helpers
